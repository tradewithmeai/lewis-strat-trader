# Darren report — daily round-up + carry hardening check (2026-07-14)
...
- `lake-snapshot.service`: **ok**, last run **04:00 UTC** (exited 0/SUCCESS); next timer fire **04:00 UTC** tomorrow.
...
- Memory: **3.2 GiB available**; swap **2.7 GiB free**.
- Outage: **none**.
- Live paper board: `xsec_momentum` remains active, **-3.32%**, **13 assets / 15 trades**, still orange. Watch, don’t promote.
...
- History: deep Binance funding backfill; common overlap now **2023-05-03 00:00 UTC → 2026-07-14 00:00 UTC**
...
- Sharpe **8.20** (95% CI **6.28, 10.40**)
- Ann. return **+5.09%**
- Ann. vol **0.62%**
- Max DD **-1.63%**
- Per-year Sharpe: **2023 +12.45**, **2024 +15.52**, **2025 +3.26**, **2026 -6.75**

**Realism stress (50% income haircut):**
- Sharpe **2.88** (95% CI **0.32, 5.50**)
- Ann. return **+1.14%**
- Ann. vol **0.40%**
- Max DD **-3.32%**
- Per-year Sharpe: **2023 +6.39**, **2024 +12.59**, **2025 -3.72**, **2026 -11.87**

**Hard stress (25% income haircut):**
- Sharpe **-2.74** (95% CI **-5.15, -0.22**)
- Ann. return **-0.84%**
- Ann. vol **0.30%**
- Max DD **-4.61%**
- Per-year Sharpe: **2023 -0.17**, **2024 +7.61**, **2025 -8.12**, **2026 -14.41**
